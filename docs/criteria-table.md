...
- Business Model (Proposed): 
    ...
    - Enterprise: Pay per seat (Multiple users can have different strategies running at the same time to capture wider audience)
- Recommended Usage: 1-3 Posts per week [Can be changed]
- Calendar: Be able to schedule posts ahead of time, and suggest when you should post
